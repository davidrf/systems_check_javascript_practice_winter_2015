$(document).ready(function() {
  $('form').submit(function(event) {
    ...
    // STEP 2: pull the dream entered by the user in the form
    // from the DOM


    // STEP 3a: call the submitDreamViaAjax function with the
...
var submitDreamViaAjax = function(description) {
  // create ajax request
  var request = $.ajax({
  ...
  request.done(function() {
    ...
    // STEP 7b: write code to update the DOM with the new dream description
